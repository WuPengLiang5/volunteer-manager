...
public class RedisUtil {
    ...
    // 7200000L
    private final long expirationMilliSeconds = 2 * 60 * 60 * 1000L;
     ...
     * @param hm    要存入的hash表
     */
    public void hset(String key, HashMap<String,Object> hm,Long expiration){
        redisTemplate.opsForHash().putAll(key,hm);
        setKeyExpire(key,expiration);
    }
